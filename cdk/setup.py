...
setuptools.setup(
    ...
    install_requires=[
        ...
        f"oe-patterns-cdk-common@git+https://github.com/ordinaryexperts/aws-marketplace-oe-patterns-cdk-common@feature/package-prototyping#egg=aws_marketplace_oe_patterns_cdk_common-40"
    ],
