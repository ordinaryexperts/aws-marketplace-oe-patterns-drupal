...
# 2) Update both AMI_ID and AMI_NAME immediately below
AMI_ID="ami-079b1505adce92b41"
AMI_NAME="ordinary-experts-drupal-pattern-0.1.0-53-g8b51742-20200526-0749"

# 3) $ ave oe-patterns-dev make AMI_ID=ami-fromstep2 copy-image
# 4) Copy the code that copy-image generates below

# AMI list generated by:
# make AMI_ID=ami-079b1505adce92b41 copy-image
# on Tue May 26 20:26:06 UTC 2020.
generated_ami_ids = {
    "us-east-2": "ami-02e6d77bf24f6c79f",
    "us-west-1": "ami-0179e5c7d9a5d3c86",
    "us-west-2": "ami-0db9df48dec457612",
    "ca-central-1": "ami-02af9f9aab4bc9555",
    "eu-central-1": "ami-09ad1534f0adcfd81",
    "eu-west-1": "ami-03b9193c68ecd1096",
    "eu-west-2": "ami-05b25b7e18896ae14",
    "eu-west-3": "ami-01db14bae06e04c76",
    "ap-northeast-1": "ami-01fe53537a8443147",
    "ap-northeast-2": "ami-07b33ef9d5b001400",
    "ap-south-1": "ami-0da2a790f5f062d8e",
    "ap-southeast-1": "ami-0ef74747a389d9f9a",
    "ap-southeast-2": "ami-0b863f77d0c0807fe",
    "us-east-1": "ami-079b1505adce92b41"
}
