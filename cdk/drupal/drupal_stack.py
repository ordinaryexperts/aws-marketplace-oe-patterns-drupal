...
# make AMI_ID=ami-091a790491abf4e71 ami-ec2-copy
# on Wed Oct 19 20:17:12 UTC 2022.
AMI_ID="ami-091a790491abf4e71"
AMI_NAME="ordinary-experts-patterns-drupal-2.0.0-20221019-0745"
generated_ami_ids = {
    "ap-northeast-1": "ami-00e3d066c5f87c0b1",
    "ap-northeast-2": "ami-070419fbc40a440ee",
    "ap-south-1": "ami-05814fcbd3a04a242",
    "ap-southeast-1": "ami-07b8df28fa05c94d4",
    "ap-southeast-2": "ami-0ba9e137619070b2d",
    "ca-central-1": "ami-06d6ec98c0d3e5f22",
    "eu-central-1": "ami-092f36b4f2385329f",
    "eu-north-1": "ami-0cd4765d80940b2d0",
    "eu-west-1": "ami-08a2f72eac1f9ac7c",
    "eu-west-2": "ami-0165805eb45c2e55b",
    "eu-west-3": "ami-03ee3beede421f06a",
    "sa-east-1": "ami-0623b2fa6fdcc74ae",
    "us-east-1": "ami-091a790491abf4e71",
    "us-east-2": "ami-09cf005cb375d5249",
    "us-west-1": "ami-07b4768a9c1115fc8",
    "us-west-2": "ami-0d2e57ed7a3b22eb4",
    "us-east-1": "ami-091a790491abf4e71"
}
        ...
        self.template_options.metadata = {
            ...
            "AWS::CloudFormation::Interface": {
                ...
                "ParameterLabels": {
                    ...
                    db_backup_retention_period_param.logical_id: {
                        "default": "RDS Snapshot Retention Period"
                    },
                    db_snapshot_identifier_param.logical_id: {
